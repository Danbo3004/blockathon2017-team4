    ...
    WalletComponent.prototype.ngOnInit = function () {
        ...
        this.checkBalanceService.checkEthBalance(this.user.address, function (data) {
            ...
            if (data.balance.length > 16) {
                _this.user.ethBalance = data.balance.slice(0, data.balance.length - 16);
            }
            else {
                _this.user.ethBalance = 0;
            }
            _this.user.ethBalance = (_this.user.ethBalance / 100).toFixed(2);
